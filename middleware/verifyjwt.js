...
const AdminOnly = (req, res, next) => {
  if (req.user.role !== 'admin') {
    console.log(req.user);
    console.log("you are not eligible for this action")
      return res.status(403).json({notautheticated:true,message:"sorry you are not eligible for this action"})
  }
  next(); // Proceed if the user is an admin
};

  module.exports = {verifyCookies,isAdmin,isStaff,AdminOnly}
