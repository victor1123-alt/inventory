...
const { AdminOnly } = require('../middleware/verifyjwt');
...
router.get('/download/:sale_id', customerController.downloadOrders);
router.get('/phones',customerController.getPhones);
router.post('/phone-brands', AdminOnly ,upload.single('image'),customerController.createPhoneBrand);
router.get('/models/:id',customerController.getPhonesModels);
router.post('/createmodel',AdminOnly,customerController.createPhoneModel);
...
router.delete("/admin/:id",AdminOnly,customerController.deleteAdmin)
router.get('/logout',customerController.logout)
// home page view routes
router.delete("/phone-models/delete/:id",AdminOnly,customerController.deletePhoneModel);
